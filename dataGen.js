...
for (x of ccfRankList.split("\n")) {
    y = x.split("\t");
    ccfFullUrl[y[2].toLowerCase()] = y[4];
    Full2Rank[y[2].toLowerCase()] = y[0];
    Abbr2Rank[y[1]] = y[0];
    // 删除Abbr2Rank空字符
    delete Abbr2Rank[""];
    if (y[4] != "") {
...
// fs.writeFileSync(
//     "ccfRankAbbr.js",
//     "ccf.rankAbbrName = " + JSON.stringify(ccfRankAbbr),
//     "utf8"
// );
// fs.writeFileSync(
//     "ccfRankFull.js",
//     "ccf.rankFullName = " + JSON.stringify(ccfRankFull),
//     "utf8"
// );
// fs.writeFileSync(
//     "ccfRankDb.js",
//     "ccf.rankDb = " + JSON.stringify(ccfRankDb),
//     "utf8"
// );
// fs.writeFileSync(
//     "ccfRankUrl.js",
...
// fs.writeFileSync(
//     "ccfAbbrFull.js",
//     "ccf.abbrFull = " + JSON.stringify(ccfAbbrFull),
//     "utf8"
// );
fs.writeFileSync(
    "Full2Rank.js",
...
fs.writeFileSync(
    "Abbr2Rank.js",
    "ccf.Abbr2Rank = " + JSON.stringify(Abbr2Rank),
    "utf8"
);
